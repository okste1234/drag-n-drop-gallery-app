				...
				<div className="hidden xl:block w-5/12 my-5 2xl:my-10 mx-2">
					<div className="flex flex-col items-center text-center">
						...
						<p className="py-6 font-medium">
							Drag and Drop Images with NextJs and Firebase.
							<br />
							Made with !happiness.
						</p>
					</div>
					<div className="flex flex-nowrap justify-center pt-6">
						<div className="mt-10">
							<Image
								...
								width={170}
								height={150}
								className="h-[150px] hover:scale-110 duration-1000"
							/>
							<Image
								alt="img2"
								src="/m3.jpg"
					...
					<div className="hero-content flex-col">
						<div className="text-center">
							...
							<p className="py-6 font-medium text-xl">
								Welcome back! <span className="text-blue-700">Login</span> to
								see photos!
							</p>
						</div>
						...
						<div className="card sm:w-[30rem] shadow-2xl bg-base-100">
							<div className="card-body">
								...
								<div className="form-control mt-6">
									...
									{error && (
										<p className="text-center text-red-700 pt-3">
											User Not Found! or invalid password/userName
										</p>
									)}
								</div>
								...
								<Link
									href={"/signup"}
									className="mt-8 btn bg-red-500 text-white font-medium text-sm"
								>
									Signup Here
								</Link>
							</div>
